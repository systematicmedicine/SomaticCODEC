...
LOW_DEPTH_MASK_INT1 = "tmp/{ms_sample}/{ms_sample}_depth_per_base.txt"
LOW_DEPTH_MASK_INT2 = "tmp/{ms_sample}/{ms_sample}_lowdepth.txt"
LOW_DEPTH_MASK_INT3 = "tmp/{ms_sample}/{ms_sample}_lowdepth_sorted.txt"
LOW_DEPTH_MASK = "tmp/{ms_sample}/{ms_sample}_lowdepth.bed"

GERMLINE_RISK_INT = "tmp/{ms_sample}/{ms_sample}_ms_pileup.bcf"
GERMLINE_RISK_VCF = "tmp/{ms_sample}/{ms_sample}_ms_germ_risk.vcf"

GERMLINE_MASK_INT1 = "tmp/{ms_sample}/{ms_sample}_germ_deletions_unformatted.bed"
GERMLINE_MASK_INT2 = "tmp/{ms_sample}/{ms_sample}_germ_insertions_unformatted.bed"
GERMLINE_MASK_INT3 = "tmp/{ms_sample}/{ms_sample}_germ_all_unformatted.bed"
GERMLINE_MASK_INT4 = "tmp/{ms_sample}/{ms_sample}_germ_deletions_unpadded.bed"
GERMLINE_MASK_INT5 = "tmp/{ms_sample}/{ms_sample}_germ_insertions_unpadded.bed"
GERMLINE_MASK_INT6 = "tmp/{ms_sample}/{ms_sample}_germ_deletions.bed"
GERMLINE_MASK_INT7 = "tmp/{ms_sample}/{ms_sample}_germ_insertions.bed"
GERMLINE_MASK_INT8 = "tmp/{ms_sample}/{ms_sample}_germ_all.bed"
GERMLINE_MASK_INT9 = "tmp/{ms_sample}/{ms_sample}_ms_germ_risk_cat_unsorted.bed"
GERMLINE_MASK_INT10 = "tmp/{ms_sample}/{ms_sample}_ms_germ_risk_cat_unmerged.bed"
