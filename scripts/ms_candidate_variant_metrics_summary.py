...
def main(snakemake):
    ...
    # Get het hom ratio from ms_het_hom_ratio.json file (generated by rule ms_het_hom_ratio)
    with open(het_hom_ratio_path) as file:
        het_hom_ratio = json.load(file)["het_hom_ratio"]
