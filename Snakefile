...
rule all:
    input:
        ...
        expand("metrics/{ms_sample}/{ms_sample}_r1_raw_fastqc.html", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_r2_raw_fastqc.html", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_trimfilter_metrics.tsv", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_trimfilter_r1_fastqc.html", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_trimfilter_r2_fastqc.html", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_markdup_metrics.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_alignment_stats.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_insert_size_metrics.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_insert_size_histogram.pdf", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_depth_stats.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_mask_metrics.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_variantCall_unfiltered_summary.txt", ms_sample = ms_samples[ms_sample_name]),
        expand("metrics/{ms_sample}/{ms_sample}_variantCall_filtered_summary.txt", ms_sample = ms_samples[ms_sample_name]),
