...
rule all:
    input:
        ...
        expand("metrics/{ms_sample_name}/{ms_sample_name}_r1_raw_fastqc.html", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_r2_raw_fastqc.html", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_trimfilter_metrics.tsv", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_trimfilter_r1_fastqc.html", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_trimfilter_r2_fastqc.html", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_markdup_metrics.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_alignment_stats.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_insert_size_metrics.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_insert_size_histogram.pdf", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_depth_stats.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_mask_metrics.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_variantCall_unfiltered_summary.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
        expand("metrics/{ms_sample_name}/{ms_sample_name}_variantCall_filtered_summary.txt", ms_sample_name = ms_samples["ms_sample_name"].tolist()),
