...
SomaticCODEC comprises a laboratory protocol for library preparation Phie *et al*. 2026 (currently under review) and a bioinformatics pipeline for analysing the resulting sequencing data ([Johnstone *et al*. 2026](https://doi.org/10.64898/2026.04.30.722079)).
