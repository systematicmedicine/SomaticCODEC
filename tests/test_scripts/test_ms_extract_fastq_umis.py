...
from tests.utils.fastq_utils import count_fastq_data_points, first_n_headers
...
# Test that UMIs were moved to the end of the headers
def test_UMIs_added_to_headers(lightweight_test_run):
